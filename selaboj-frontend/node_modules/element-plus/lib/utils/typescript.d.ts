...
type ObjectFit = 'fill' | 'contain' | 'cover' | 'none' | 'scale-down' | Globals;
type ZIndexType = Globals | 'auto' | number;
type AlignItems = 'normal' | 'stretch' | 'center' | 'start' | 'end' | 'flex-start' | 'flex-end' | 'self-start' | 'self-end' | 'anchor-center' | 'baseline' | 'first baseline' | 'last baseline' | 'safe center' | 'unsafe center' | Globals;
//#endregion
export { AlignItems, Arrayable, Awaitable, FieldPath, HTMLElementCustomized, Mutable, Nullable, ObjectFit, ZIndexType, mutable };